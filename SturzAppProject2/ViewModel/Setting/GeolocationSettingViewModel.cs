...
{
    public class GeolocationSettingViewModel : INotifyPropertyChanged
    {
        //###################################################################################
        //################################### Construtors ###################################
        //###################################################################################
        ...
        public GeolocationSettingViewModel(bool isUsed, bool isRecordSamples, uint reportInterval)
        {
            this.IsUsed = isUsed;
